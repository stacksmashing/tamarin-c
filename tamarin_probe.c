 ...
 * Copyright (c) 2022-2023 Thomas Roth <code@stacksmashing.net>
...
void tamarin_start_probe()
{
    ...
    gpio_put(PROBE_PIN_SWDIO_DIR, SHIFTER_DIRECTION_OUT);
    pio_sm_set_consecutive_pindirs(pio0, PROBE_SM, PROBE_PIN_SWCLK, 1, true);
    pio_sm_set_consecutive_pindirs(pio0, PROBE_SM, PROBE_PIN_SWDIO, 1, true);
    // Enable SM
...
void tamarin_probe_init()
{
    ...
    gpio_put(PROBE_PIN_SWDIO_DIR, SHIFTER_DIRECTION_IN);
    pio_sm_set_consecutive_pindirs(pio0, PROBE_SM, PROBE_PIN_SWCLK, 1, false);
    pio_sm_set_consecutive_pindirs(pio0, PROBE_SM, PROBE_PIN_SWDIO, 1, false);
